 ...
 * Anvesh is. Then the AnveshOS brand materializes. Then the world opens.
 *
 * Phases:
 *   word-1  (0–700ms)    "Anvesh."
 *   word-2  (700–1300ms) "Engineer."
 *   word-3  (1300–1900ms)"Builder."
 *   brand   (1900–2500ms) AnveshOS + hairline rule + v2.0
...
const WORDS = ['Anvesh.', 'Engineer.', 'Builder.'];
const PHASE_ORDER: Phase[] = ['word-1', 'word-2', 'word-3', 'brand', 'reveal'];
const PHASE_DURATIONS: Record<Phase, number> = {
  'word-1': 1300,   // "Anvesh." — name, let it land
  'word-2': 1100,   // "Engineer."
  'word-3': 1100,   // "Builder."
  'brand':  1400,   // AnveshOS — breathe before the reveal
