/**
 * AnveshOS Personality Copy System
 *
...
export const bootMessages = [
  { text: 'AnveshOS v2.0 starting up...', delay: 0 },
  ...
  { text: 'Welcome to AnveshOS.', delay: 3200 },
];
...
export const emptyStates = {
  ...
  terminalWelcome: "AnveshOS terminal. Type 'help' if lost. No judgment.",
};
...
export const notifications = {
  ...
  idleNudge: {
    title: 'Still here?',
    body: 'Open the terminal. Type `hire Anvesh`. See what happens.',
  },
  terminalTip: {
    title: 'Psst.',
...
export const bsodCopy = {
  title: 'AnveshOS has encountered a problem and needs to restart.',
