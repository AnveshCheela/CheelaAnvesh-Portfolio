...
export const SKILLS: Skill[] = [
  ...
  { id: 'llmeval',    name: 'LLM Evaluation',   category: 'ai',       level: 4, xp: '1 yr',    description: 'Hit@k, MRR, NDCG metrics. Built eval pipelines to systematically measure retrieval quality.',               deps: [] },
  { id: 'vertexai',   name: 'Vertex AI',        category: 'ai',       level: 3, xp: '1 yr',    description: 'Model deployment, batch prediction, and managed endpoints on GCP.',                                          deps: [] },
